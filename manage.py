...
from zippy.app import create_app
from zippy.database import db
from zippy.settings import DevConfig, ProdConfig
from zippy.user.models import User

CONFIG = ProdConfig if os.environ.get('ZIPPY_ENV') == 'prod' else DevConfig
